                    ...
                    <div className='hamburger'>
                        ...
                        <div className={`hamburger__menu ${hamburgerMenu ? 'active' : ''}`}>
                            <div className='hamburger__menu__box'>
                                ...
                                <NavLink onClick={toggleHamburger} to='/funds'>Fondai</NavLink>
                                <NavLink onClick={toggleHamburger} to='/about'>Apie mus</NavLink>
                                <NavLink onClick={toggleHamburger} to='/contact'>Susisiek</NavLink>
